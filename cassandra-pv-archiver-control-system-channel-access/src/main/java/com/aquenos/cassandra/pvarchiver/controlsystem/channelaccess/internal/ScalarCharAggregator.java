...
/**
 * <p>
 * Aggregator for scalar char samples. This aggregator consumes samples of type
 * <code>SCALAR_CHAR</code> and produces samples of type
 ...
 */
public class ScalarCharAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public ScalarCharAggregator(long intervalStartTime, long intervalLength,
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        // a precondition.
        assert (sample.getType().equals(ChannelAccessSampleType.SCALAR_CHAR));
        byte value = sampleValueAccess
                .deserializeByteValueColumn((ChannelAccessRawSample) sample);
        minimum = (byte) Math.min(value, minimum);
        maximum = (byte) Math.max(value, maximum);
