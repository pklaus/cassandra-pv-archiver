...
/**
 * <p>
 * Aggregator for aggregated scalar char samples. This aggregator consumes
 * samples of type <code>AGGREGATED_SCALAR_CHAR</code> and produces samples of
 * the same type.
 * </p>
 * 
 * <p>
 ...
 */
public class AggregatedScalarCharAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public AggregatedScalarCharAggregator(long intervalStartTime,
            long intervalLength,
            ChannelAccessSampleValueAccess sampleValueAccess) {
        super(intervalStartTime, intervalLength, sampleValueAccess);
        minimum = Byte.MAX_VALUE;
        maximum = Byte.MIN_VALUE;
    }
    ...
    public ChannelAccessSample getAggregatedSample() {
        ...
        return sampleValueAccess.createAggregatedScalarCharSample(
    ...
    protected long calculateSampleValidPeriod(long startTimeStamp,
        ...
        assert (sample.getType()
                .equals(ChannelAccessSampleType.AGGREGATED_SCALAR_CHAR));
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        minimum = (byte) Math.min(
                sampleValueAccess.deserializeByteMinColumn(aggregatedSample),
                minimum);
        maximum = (byte) Math.max(
                sampleValueAccess.deserializeByteMaxColumn(aggregatedSample),
                maximum);
