 ...
 * <code>SCALAR_DOUBLE</code> and produces samples of type
 ...
 */
public class ScalarDoubleAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public ScalarDoubleAggregator(long intervalStartTime, long intervalLength,
    ...
    public ChannelAccessSample getAggregatedSample() {
        ...
        return sampleValueAccess.createAggregatedScalarDoubleSample(
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        // a precondition.
        assert (sample.getType().equals(ChannelAccessSampleType.SCALAR_DOUBLE));
        double value = sampleValueAccess
                .deserializeDoubleValueColumn((ChannelAccessRawSample) sample);
        minimum = Math.min(value, minimum);
        maximum = Math.max(value, maximum);
        sum += sampleValidPeriod * value;
        sumOfSquares += sampleValidPeriod * value * value;
    }
