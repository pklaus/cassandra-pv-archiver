...
/**
 * <p>
 * Aggregator for scalar long samples. This aggregator consumes samples of type
 * <code>SCALAR_LONG</code> and produces samples of type
 ...
 */
public class ScalarLongAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public ScalarLongAggregator(long intervalStartTime, long intervalLength,
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        // a precondition.
        assert (sample.getType().equals(ChannelAccessSampleType.SCALAR_LONG));
        int value = sampleValueAccess
                .deserializeLongValueColumn((ChannelAccessRawSample) sample);
