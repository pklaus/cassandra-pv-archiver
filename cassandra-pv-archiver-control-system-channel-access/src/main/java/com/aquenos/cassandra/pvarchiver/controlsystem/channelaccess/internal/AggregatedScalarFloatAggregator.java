...
/**
 * <p>
 * Aggregator for aggregated scalar float samples. This aggregator consumes
 * samples of type <code>AGGREGATED_SCALAR_FLOAT</code> and produces samples of
 * the same type.
 * </p>
 * 
 * <p>
 ...
 */
public class AggregatedScalarFloatAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public AggregatedScalarFloatAggregator(long intervalStartTime,
            long intervalLength,
    ...
    protected long calculateSampleValidPeriod(long startTimeStamp,
        ...
        assert (sample.getType()
                .equals(ChannelAccessSampleType.AGGREGATED_SCALAR_FLOAT));
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        minimum = Math.min(
                sampleValueAccess.deserializeFloatMinColumn(aggregatedSample),
                minimum);
        maximum = Math.max(
                sampleValueAccess.deserializeFloatMaxColumn(aggregatedSample),
                maximum);
