...
/**
 * <p>
 * Aggregator for aggregated scalar double samples. This aggregator consumes
 * samples of type <code>AGGREGATED_SCALAR_DOUBLE</code> and produces samples of
 * the same type.
 * </p>
 * 
 * <p>
 ...
 */
public class AggregatedScalarDoubleAggregator extends AveragingSampleAggregator {
     ...
     *            aggregator.
     */
    public AggregatedScalarDoubleAggregator(long intervalStartTime,
            long intervalLength,
    ...
    protected long calculateSampleValidPeriod(long startTimeStamp,
        ...
        assert (sample.getType()
                .equals(ChannelAccessSampleType.AGGREGATED_SCALAR_DOUBLE));
    ...
    protected void processSampleValue(ChannelAccessUdtSample sample,
        ...
        minimum = Math.min(
                sampleValueAccess.deserializeDoubleMinColumn(aggregatedSample),
                minimum);
        maximum = Math.max(
                sampleValueAccess.deserializeDoubleMaxColumn(aggregatedSample),
                maximum);
